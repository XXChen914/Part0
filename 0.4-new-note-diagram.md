...
sequenceDiagram
    ...
    Note left of server: with 302 status code the server asks the browser to perform a new HTTP GET request to the address defined in the header's Location.
