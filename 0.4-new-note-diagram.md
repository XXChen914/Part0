...
sequenceDiagram
    ...
    Note right of browser: The user submit a new note with the form.

    browser->>server: POST https://studies.cs.helsinki.fi/exampleapp/new_note
    activate server

    Note right of browser: The browser sends a HTTP POST request to the server address new_note with new note data
